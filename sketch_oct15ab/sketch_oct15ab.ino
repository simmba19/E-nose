...
void loop()
{
    ...
    Serial.println(" ppm");
    Serial.print("Voltage value for NH3 is: ");
    //Serial.println(volt.calcVol(c));
    Serial.println(gas.calcGas(c));
    ...
    Serial.println(" ppm");
    Serial.print("Voltage value for CO is: ");
    //Serial.println(volt.calcVol(c));
    Serial.println(gas.calcGas(c));
    ...
    Serial.println(" ppm");
    Serial.print("Voltage value for NO2 is: ");
    //Serial.println(volt.calcVol(c));
    Serial.println(gas.calcGas(c));
    ...
    Serial.println(" ppm");
    Serial.print("Voltage vaue for C3H8 is: ");
    //Serial.println(volt.calcVol(c));
    Serial.println(gas.calcGas(c));
    ...
    Serial.println(" ppm");
    Serial.print("Voltage value for C4H10 is: ");
    //Serial.println(volt.calcVol(c));
    Serial.println(gas.calcGas(c));
    ...
    Serial.println(" ppm");
    Serial.print("Voltage value for CH4 is: ");
    //Serial.println(volt.calcVol(c));
    Serial.println(gas.calcGas(c));
    ...
    Serial.println(" ppm");
    Serial.print("Voltage value for H2: ");
    //Serial.println(volt.calcVol(c));
    Serial.println(gas.calcGas(c));
    ...
    Serial.println(" ppm");
    Serial.print("Voltage value for C2H5OH is: ");
    //Serial.println(volt.calcVol(c));
    Serial.println(gas.calcGas(c));

    Serial.println("----Resistance------");
    Serial.print("The R0 and Rs of CH3 is  ");
    Serial.print(gas.getR0(0));
    Serial.print(" and ");
